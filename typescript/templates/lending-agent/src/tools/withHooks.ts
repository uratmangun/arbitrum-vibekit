 ...
 */
export interface LendingHookConfig<TArgs, TResult, TContext = any, TSkillInput = any> {
  before?: BeforeHook<TArgs, TContext, TSkillInput>;
  after?: AfterHook<TResult, TArgs, TContext, TSkillInput>;
}

/**
 * Wraps a VibkitToolDefinition with before/after hooks for the lending agent.
